...
`f779343` (code/evidence plus compatibility-preserving parser/schema/test
fixes and the current candidate evidence snapshot); commits after this
boundary are documentation-only status/review updates. The
