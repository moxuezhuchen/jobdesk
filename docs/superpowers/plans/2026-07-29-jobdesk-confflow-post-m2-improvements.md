...
`a6c88ca` (code/evidence base); later commits on this isolated branch are
documentation-only status/review updates, with the latest pre-status-update
snapshot at `b62fb3c`. The
