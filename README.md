...
JobDesk is currently a preview project with an isolated `0.7.6` source
candidate. The released JobDesk package is `v0.7.5`; the current published
...
| Isolated implementation candidate | JobDesk `0.7.6` package-data fix based on released `v0.7.5`; no producer source change | Candidate code under review; no release or endpoint switch |
...
The `0.7.6` value above identifies an isolated source candidate only. The
