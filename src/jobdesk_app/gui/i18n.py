...
ZH: dict[str, str] = {
    ...
    "Toggle navigation labels": "\u5207\u6362\u5bfc\u822a\u6807\u7b7e\u663e\u793a",
    "(no geometry parsed)": "\uff08\u672a\u89e3\u6790\u5230\u51e0\u4f55\u7ed3\u6784\uff09",
    "0 (minimum)": "0\uff08\u6700\u5c0f\u503c\uff09",
    ...
    "All workflows": "\u6240\u6709\u5de5\u4f5c\u6d41",
    "Any date": "\u4efb\u610f\u65e5\u671f",
    "Add the current draft step to the workflow.": "\u5c06\u5f53\u524d\u8349\u7a3f\u6b65\u9aa4\u6dfb\u52a0\u5230\u5de5\u4f5c\u6d41\u3002",
    "Basic": "\u57fa\u672c\u4fe1\u606f",
    "Choose an existing local directory, or leave blank to use the current location.": "\u9009\u62e9\u73b0\u6709\u672c\u5730\u76ee\u5f55\uff0c\u6216\u7559\u7a7a\u4ee5\u4f7f\u7528\u5f53\u524d\u4f4d\u7f6e\u3002",
    "Connect to a server before submitting.": "\u63d0\u4ea4\u524d\u8bf7\u5148\u8fde\u63a5\u670d\u52a1\u5668\u3002",
    "Connected": "\u5df2\u8fde\u63a5",
    "(uncertain task \u2014 no parsed output)": "\uff08\u72b6\u6001\u4e0d\u786e\u5b9a\u4efb\u52a1\u2014\u2014\u6ca1\u6709\u53ef\u89e3\u6790\u8f93\u51fa\uff09",
    "Collapse activity log": "\u6536\u8d77\u6d3b\u52a8\u65e5\u5fd7",
    "CPU time": "CPU \u65f6\u95f4",
    "Disconnected: {server_id}": "\u672a\u8fde\u63a5: {server_id}",
    "Draft step \u2014 not added to workflow.": "\u8349\u7a3f\u6b65\u9aa4\u2014\u2014\u5c1a\u672a\u6dfb\u52a0\u5230\u5de5\u4f5c\u6d41\u3002",
    "Enter an executable path or a command available on PATH, such as notepad.exe or code.": "\u8f93\u5165\u53ef\u6267\u884c\u6587\u4ef6\u8def\u5f84\uff0c\u6216 PATH \u4e2d\u53ef\u7528\u7684\u547d\u4ee4\uff0c\u4f8b\u5982 notepad.exe \u6216 code\u3002",
    "Enter an executable path or a command available on PATH, such as wt or putty.exe.": "\u8f93\u5165\u53ef\u6267\u884c\u6587\u4ef6\u8def\u5f84\uff0c\u6216 PATH \u4e2d\u53ef\u7528\u7684\u547d\u4ee4\uff0c\u4f8b\u5982 wt \u6216 putty.exe\u3002",
    "Error termination": "\u9519\u8bef\u7ec8\u6b62",
    "Expand activity log": "\u5c55\u5f00\u6d3b\u52a8\u65e5\u5fd7",
    "Executable path does not exist; use an existing file or a command available on PATH": "\u53ef\u6267\u884c\u6587\u4ef6\u8def\u5f84\u4e0d\u5b58\u5728\uff1b\u8bf7\u4f7f\u7528\u5df2\u5b58\u5728\u7684\u6587\u4ef6\u6216 PATH \u4e2d\u53ef\u7528\u7684\u547d\u4ee4",
    "Final geometry (XYZ, first 100 lines)": "\u6700\u7ec8\u51e0\u4f55\u7ed3\u6784\uff08XYZ\uff0c\u524d 100 \u884c\uff09",
    "Final SCF energy": "\u6700\u7ec8 SCF \u80fd\u91cf",
    "Gibbs free energy": "\u5409\u5e03\u65af\u81ea\u7531\u80fd",
    "Imaginary frequencies": "\u865a\u9891\u6570",
    "Fix the global YAML before continuing.": "\u7ee7\u7eed\u524d\u8bf7\u4fee\u590d\u5168\u5c40 YAML\u3002",
    "Fix invalid paths before saving": "\u4fdd\u5b58\u524d\u8bf7\u4fee\u590d\u65e0\u6548\u8def\u5f84",
    "Fix the step YAML before continuing.": "\u7ee7\u7eed\u524d\u8bf7\u4fee\u590d\u6b65\u9aa4 YAML\u3002",
    "Fix workflow validation errors before continuing.": "\u7ee7\u7eed\u524d\u8bf7\u4fee\u590d\u5de5\u4f5c\u6d41\u6821\u9a8c\u9519\u8bef\u3002",
    "Host is required": "\u4e3b\u673a\u4e0d\u80fd\u4e3a\u7a7a",
    "ID:": "ID\uff1a",
    "Last refresh: Never": "\u4e0a\u6b21\u5237\u65b0\uff1a\u5c1a\u672a\u5237\u65b0",
    "Last refresh: {time}": "\u4e0a\u6b21\u5237\u65b0\uff1a{time}",
    "Last updated: {time}": "\u6700\u540e\u66f4\u65b0\uff1a{time}",
    "Local directory does not exist": "\u672c\u5730\u76ee\u5f55\u4e0d\u5b58\u5728",
    "Local {local_count} selected, {local_visible}/{local_total} visible | Remote {remote_count} selected, {remote_visible}/{remote_total} visible": "\u5df2\u9009\uff1a\u672c\u5730 {local_count}\uff0c\u53ef\u89c1 {local_visible}/{local_total} | \u8fdc\u7a0b {remote_count}\uff0c\u53ef\u89c1 {remote_visible}/{remote_total}",
    "No response": "\u65e0\u54cd\u5e94",
    "Browse SSH key": "\u9009\u62e9 SSH \u5bc6\u94a5",
    "Choose an SSH private key file": "\u9009\u62e9 SSH \u79c1\u94a5\u6587\u4ef6",
    "CPUs:": "CPU \u6838\u6570\uff1a",
    "No status": "\u65e0\u72b6\u6001",
    "Normal termination": "\u6b63\u5e38\u7ec8\u6b62",
    "Normal termination of Gaussian": "Gaussian \u6b63\u5e38\u7ec8\u6b62",
    "Not tested": "\u672a\u6d4b\u8bd5",
    "ORCA TERMINATED NORMALLY": "ORCA \u6b63\u5e38\u7ec8\u6b62",
    "Off by default. Enabling this trusts and stores an unknown SSH host key on first connection; verify the host fingerprint through a trusted channel.": "\u9ed8\u8ba4\u5173\u95ed\u3002\u542f\u7528\u540e\uff0c\u9996\u6b21\u8fde\u63a5\u5c06\u4fe1\u4efb\u5e76\u4fdd\u5b58\u672a\u77e5 SSH \u4e3b\u673a\u5bc6\u94a5\uff1b\u8bf7\u901a\u8fc7\u53ef\u4fe1\u6e20\u9053\u6838\u5bf9\u4e3b\u673a\u6307\u7eb9\u3002",
    "Past 7 days": "\u8fc7\u53bb 7 \u5929",
    "Past 30 days": "\u8fc7\u53bb 30 \u5929",
    "Only enable this after verifying the server identity through a trusted channel. Continue?": "\u4ec5\u5728\u901a\u8fc7\u53ef\u4fe1\u6e20\u9053\u6838\u5bf9\u670d\u52a1\u5668\u8eab\u4efd\u540e\u542f\u7528\u3002\u662f\u5426\u7ee7\u7eed\uff1f",
    "Other": "\u5176\u4ed6",
    "Ready to submit.": "\u53ef\u4ee5\u63d0\u4ea4\u3002",
    "Ready to test": "\u53ef\u4ee5\u6d4b\u8bd5",
    "Remote listed: {path} ({count} entries)": "\u8fdc\u7a0b\u76ee\u5f55\u5df2\u5217\u51fa\uff1a{path}\uff08{count} \u9879\uff09",
    "Remote path missing, trying: {path}": "\u8fdc\u7a0b\u8def\u5f84\u4e0d\u5b58\u5728\uff0c\u6b63\u5728\u5c1d\u8bd5\uff1a{path}",
    "Refresh already in progress": "\u5237\u65b0\u5df2\u5728\u8fdb\u884c\u4e2d",
    "Runs: {visible} of {total}": "\u8fd0\u884c\uff1a{visible}/{total}",
    "SSH and proxy": "SSH \u4e0e\u4ee3\u7406",
    "Save the workflow.": "\u4fdd\u5b58\u5de5\u4f5c\u6d41\u3002",
    "Scheduler and resources": "\u8c03\u5ea6\u5668\u4e0e\u8d44\u6e90",
    "Search local files": "\u641c\u7d22\u672c\u5730\u6587\u4ef6",
    "Search remote files": "\u641c\u7d22\u8fdc\u7a0b\u6587\u4ef6",
    "Search runs": "\u641c\u7d22\u8fd0\u884c",
    "Select a run to enable this action": "\u8bf7\u9009\u62e9\u4e00\u6761\u8fd0\u884c\u4ee5\u542f\u7528\u6b64\u64cd\u4f5c",
    "Select one or more files to submit": "\u8bf7\u9009\u62e9\u4e00\u4e2a\u6216\u591a\u4e2a\u6587\u4ef6\u4ee5\u63d0\u4ea4",
    "Submit {count} local": "\u63d0\u4ea4 {count} \u4e2a\u672c\u5730\u9879",
    "Submit {count} remote": "\u63d0\u4ea4 {count} \u4e2a\u8fdc\u7a0b\u9879",
    "Tasks:": "\u4efb\u52a1\uff1a",
    "Terminal integration": "\u7ec8\u7aef\u96c6\u6210",
    "Termination": "\u7ec8\u6b62\u72b6\u6001",
    "This run has no active tasks": "\u6b64\u8fd0\u884c\u6ca1\u6709\u6d3b\u52a8\u4efb\u52a1",
    "This run has no failed tasks": "\u6b64\u8fd0\u884c\u6ca1\u6709\u5931\u8d25\u4efb\u52a1",
    "This run has no tasks awaiting download": "\u6b64\u8fd0\u884c\u6ca1\u6709\u5f85\u4e0b\u8f7d\u4efb\u52a1",
    "Trust unknown host:": "\u4fe1\u4efb\u672a\u77e5\u4e3b\u673a\uff1a",
    "Trust unknown host": "\u4fe1\u4efb\u672a\u77e5\u4e3b\u673a",
    "Trust unknown host?": "\u662f\u5426\u4fe1\u4efb\u672a\u77e5\u4e3b\u673a\uff1f",
    "Trust and store an unknown SSH host key on first connection after verifying its fingerprint.": "\u5728\u6838\u5bf9\u4e3b\u673a\u6307\u7eb9\u540e\uff0c\u9996\u6b21\u8fde\u63a5\u65f6\u4fe1\u4efb\u5e76\u4fdd\u5b58\u672a\u77e5 SSH \u4e3b\u673a\u5bc6\u94a5\u3002",
    "Today": "\u4eca\u5929",
    "Unsaved changes": "\u6709\u672a\u4fdd\u5b58\u7684\u66f4\u6539",
    "Username is required": "\u7528\u6237\u540d\u4e0d\u80fd\u4e3a\u7a7a",
    "Validate the workflow YAML.": "\u6821\u9a8c\u5de5\u4f5c\u6d41 YAML\u3002",
    "Workflow YAML has errors.": "\u5de5\u4f5c\u6d41 YAML \u5b58\u5728\u9519\u8bef\u3002",
    "Workflow YAML is not ready.": "\u5de5\u4f5c\u6d41 YAML \u5c1a\u672a\u5c31\u7eea\u3002",
    "Workflow YAML is valid.": "\u5de5\u4f5c\u6d41 YAML \u6821\u9a8c\u901a\u8fc7\u3002",
    "workflow input": "\u5de5\u4f5c\u6d41\u8f93\u5165",
    "Wall time": "\u5b9e\u9645\u7528\u65f6",
    "Zero-point correction": "\u96f6\u70b9\u80fd\u6821\u6b63",
    "{n} atoms": "{n} \u4e2a\u539f\u5b50",
    "{n} imaginary": "{n} \u4e2a\u865a\u9891",
    "1. Choose or edit a step": "1. \u9009\u62e9\u6216\u7f16\u8f91\u6b65\u9aa4",
    "2. Add steps to the workflow": "2. \u5c06\u6b65\u9aa4\u6dfb\u52a0\u5230\u5de5\u4f5c\u6d41",
    "3. Validate and save the workflow": "3. \u6821\u9a8c\u5e76\u4fdd\u5b58\u5de5\u4f5c\u6d41",
    "4. Submit a saved workflow": "4. \u63d0\u4ea4\u5df2\u4fdd\u5b58\u7684\u5de5\u4f5c\u6d41",
    "Uncertain": "\u72b6\u6001\u4e0d\u786e\u5b9a",
