...
from jobdesk_app.infrastructure.persistence.sqlite_runs import (
    OperationRecord,
)
from jobdesk_app.infrastructure.runtime.submit_ownership import (
...
def submit_run(
    ...
    """
    # Lazy import so tests can monkeypatch jobdesk_app.infrastructure.runtime.run_service.JobSubmitter
    import jobdesk_app.infrastructure.runtime.run_service as _rs

    JobSubmitter = _rs.JobSubmitter
    from jobdesk_app.infrastructure.remote.scheduler import ResourceSpec, make_adapter
