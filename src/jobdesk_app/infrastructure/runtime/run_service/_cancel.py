...
from jobdesk_app.infrastructure.persistence.sqlite_runs import RunRecord, RunRepository
...
def _cancel_run_locked(
    ...
    from jobdesk_app.infrastructure.remote.scheduler import make_adapter
